...
# Project Title: Team Portfolio genrator
...
-------------------------------------------------------------------------------------
### Description: 
* in this project we used node and npm packages to generate a team portfolio. We used constructor objects as classes to create various personas within a team. We used new concepts such as inheritence and more

### Installation: 
* npm modules, jest, inquirer
...
### Tests: 
* I used jest as the testing framework for this project

### Contributors: 
* Others are welcome to contribute

Questions
* for more questions pleaes email me at rehmank11@gmail.com
